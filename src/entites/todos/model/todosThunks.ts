...
// creating a new todo
export const createTodo = createAsyncThunk("todos/create", async (todo: Omit<Todo, "id">) => {
...
export const updateTodo = createAsyncThunk(
	"todos/update",
	async ({ id, data }: { id: number; data: Partial<Todo> }) => todoApi.update(id, data)
);

// deleting a todo
export const deleteTodo = createAsyncThunk("todos/delete", async (id:number) => todoApi.remove(id));
